...
export const specialtyServices: SpecialtyServicesContent = {
  cards: [
    ...
    },
    {
      ctaLabel: "Explore this service",
      description:
        "Genuine and high-quality aftermarket spare parts, supplied and installed with expert care for lasting performance.",
      image: "/images/services/specialty/spare-parts-hero.webp",
      imageAlt:
        "Genuine and aftermarket automotive spare parts arranged on a workshop counter",
      slug: "spare-parts",
    ...
    },
    {
      ctaLabel: "Explore this service",
      description:
        "Car wash, chemical wash, tinting, nano ceramic coating, deep cleaning, steam cleaning, and full detailing.",
  ...
  pages: [
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Common mechanical and electrical roadside repairs",
            "Fluid top-ups and practical maintenance where suitable",
            "Clear estimate before work begins",
            "Service at home, office, or roadside locations",
          ],
        ...
        },
        {
          ...
          items: [
            ...
            "Delivery to our garage or your chosen location",
            "Careful handling for everyday and luxury vehicles",
            "Coordinated handover with our workshop team",
          ],
      ...
      sections: [
        {
          ...
          image: "/images/services/specialty/spare-parts-hero.webp",
          imageAlt:
            "OEM-style filters, brake discs, and packaged automotive spare parts",
          items: [
            "Genuine OEM spare parts supply",
            "Correct part matching for your make and model",
            "Engine, brake, electrical, and service components",
            "Quality focused on durability and original fit",
            "Transparent advice on when genuine parts are best",
            "Professional installation in our workshop",
          ],
          title: "Genuine Spare Parts",
        },
        {
          body: [
            "High-quality aftermarket parts offer strong performance and value when selected carefully. We work with trusted suppliers and install only parts we are confident will support safe, dependable operation.",
            "Whether you need a cost-effective service part or a durable replacement for daily driving, we help you choose wisely without compromising workmanship.",
          ],
          image: "/images/services/specialty/spare-parts-aftermarket.webp",
          imageAlt:
            "Aftermarket brake pads, air filter, belt, and hose parts on a workshop bench",
          items: [
            "Trusted aftermarket spare parts options",
            "Balanced choices for quality and value",
            "Suitable parts for maintenance and repairs",
            "Expert guidance based on your driving needs",
            "Careful fitment and workshop installation",
            "Support for most major vehicle brands",
          ],
    ...
    },
    {
      ...
      sections: [
        {
          body: [
            "Keep your vehicle looking fresh with thorough exterior washing and deeper chemical wash treatments that lift stubborn dirt, road film, and built-up residue from paint and bodywork.",
            "Ideal for regular care or when your car needs a stronger clean after dusty roads, coastal driving, or heavy city use.",
          ],
          image: "/images/services/specialty/car-wash-steam.webp",
          imageAlt:
            "Luxury sedan receiving a professional foam car wash in a clean bay",
          items: [
            "Professional car wash",
            "Chemical wash for deeper exterior cleaning",
            "Removal of road film and stubborn dirt",
            "Careful cleaning around bodywork and trim",
            "Suitable for everyday cars and luxury vehicles",
            "A cleaner, fresher finish after every visit",
          ],
          title: "Car Wash & Chemical Wash",
        },
        {
          body: [
            "Window tinting improves comfort, privacy, and cabin temperature control, while nano ceramic coating adds long-lasting gloss and protection against UV, light scratches, and environmental fallout.",
            "We apply both with precision so your glass and paint look refined and stay easier to maintain.",
          ],
          image: "/images/services/specialty/window-tinting.webp",
          imageAlt:
            "Technician applying professional window tint film to a vehicle",
          items: [
            "Professional window tinting",
            "Improved heat and glare reduction",
            "Enhanced cabin privacy and comfort",
            "Nano ceramic coating for lasting gloss",
            "Paint protection against UV and contaminants",
            "Easier cleaning and a premium showroom finish",
          ],
          title: "Window Tinting & Nano Ceramic Coating",
        },
        {
          body: [
          ...
          image: "/images/services/specialty/car-care-hero.webp",
          imageAlt:
            "Detailed exterior finishing and ceramic coating on a black sedan",
          items: [
            "Deep cleaning for cabin and exterior surfaces",
            "Steam cleaning for thorough, careful sanitation",
            "Interior detailing for seats, panels, and trims",
            "Exterior detailing for paint clarity and shine",
            "Complete care packages for a full refresh",
            "Attention to finish quality from start to handover",
          ],
          title: "Deep Cleaning, Steam Cleaning & Detailing",
        },
      ],
      slug: "car-care",
      title: "Car Care Services",
